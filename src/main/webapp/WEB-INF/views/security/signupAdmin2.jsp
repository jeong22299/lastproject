								...
								<div class="main-container container-fluid">
									<div class="row row-sm">
										<div class="card-body mt-2 mb-2">
											...
											<p class="mb-4 text-muted tx-13 ms-0 text-start">관리자(관리자 정보)</p>
											<form name="frm" id="frm" method="post" action="/security/insertAdmin">
...
function OKConfirm(){
	...
	if (mailJ.test($('#empEml').val())){
		console.log(mailJ.test($('#empEml').val()));
		inval_Arr[2] = true;
	} else {
		inval_Arr[2] = false;
	}
	...
	if (phoneJ.test($('#empTel').val())) {
		console.log(phoneJ.test($('#empTel').val()));
		inval_Arr[3] = true;
	} else {
		inval_Arr[3] = false;
	}
