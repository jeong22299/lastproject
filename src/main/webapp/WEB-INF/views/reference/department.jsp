...
<div class="tab-pane table-responsive" id="tabCont2">
	<div id="example1_wrapper"
		class="dataTables_wrapper dt-bootstrap5 no-footer table-striped">
		...
		<div class="row">
			<div class="col-sm-12">
				<table
					...
					<c:set var = "depCd" value = "${totalRefeVO.depCd}"/> 
					<c:if test="${refeName eq 'R02' && depCd eq prcDepCd}">
...
let refeNm = $("input[name=department]").val();
  $('#thefiles').FancyFileUpload({
     ...
     startupload : function(SubmitUpload, e, data) {
         ...
         let refeCon = $(".ff_fileupload_filecon").val();
         console.log("refeCon 체크: " , refeCon);
          ...
          for(let i=0; i<data.originalFiles.length; i++){
           ...
           formData.append("refeCon",refeCon);
           }
